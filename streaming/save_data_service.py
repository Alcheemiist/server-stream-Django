from .models import InferenceResult, Detection, BoundingBox, Center, ImageSize
    ...
    try:
        with transaction.atomic():
            for inference in json_data:
                ...
                # Créer une nouvelle instance ImageSize, même si les dimensions sont identiques
                ...
                for det in inference.get("detections", []):
                    ...
                    # Vérifier ou créer une instance BoundingBox
                    ...
                    # Créer une nouvelle instance Center
                    center = Center.objects.create(
                        x=center_data["x"],
                        y=center_data["y"]
                    )

                    # Créer une nouvelle instance Detection
                    Detection.objects.create(
                        ...
                        area=det.get("area", 0),  # Défaut : 0 si non défini
                        center=center
                    )
