...
def synchronize_sequences():
    ...
    """
    databases = ['default', 'people', 'vehicles', 'garbage']  # Toutes vos bases
        ...
        try:
            ...
            if filtered_detections.exists():
                with connections[db_name].cursor() as cursor:
                    ...
                    # Création d'un nouveau InferenceResult
                    cursor.execute(
                        """
                        INSERT INTO streaming_inferenceresult (timestamp, inference_time, frame_id, model, device, zone, image_size_id)
                    ...
                    # Création des BoundingBoxes, Centers et Détections
                    for det in filtered_detections:
                        # Création d'un nouveau BoundingBox
                        cursor.execute(
                            """
                        ...
                        # Création d'une nouvelle Detection
                        cursor.execute(
                            """
